...
def main():
    ...
    #even_better_draw_circles(rg.Point(200, 50), 30, 10, 'red', 3)
    even_better_draw_circles(rg.Point(-200, 200), 15, 20, 'red', 8)
    even_better_draw_circles(rg.Point(-200, -200), 15, 20, 'blue', 8)
    even_better_draw_circles(rg.Point(200, 200), 15, 20, 'green', 8)
    even_better_draw_circles(rg.Point(200, -200), 15, 20, 'yellow', 8)
    even_better_draw_circles(rg.Point(0, 0), 15, 20, 'orange', 8)
...
def better_draw_circles(point, rad_diff):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(rad_diff)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(rad_diff * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, rad_diff, num, color, thickness):
    ...
    for k in range(num):  # k becomes 1, 2, 3, ... 10
